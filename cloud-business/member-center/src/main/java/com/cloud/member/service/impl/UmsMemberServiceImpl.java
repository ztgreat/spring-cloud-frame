...
import com.cloud.common.vo.SmsCode;
import com.cloud.member.config.WxAppletProperties;
import com.cloud.common.entity.ums.Sms;
import com.cloud.member.mapper.SysAreaMapper;
import com.cloud.member.mapper.UmsMemberMapper;
import com.cloud.member.mapper.UmsMemberMemberTagRelationMapper;
import com.cloud.member.service.IUmsMemberLevelService;
import com.cloud.member.service.IUmsMemberService;
import com.cloud.member.service.RedisService;
import com.cloud.member.service.SmsService;
import com.cloud.member.utils.CharUtil;
import com.cloud.member.utils.CommonUtil;
import com.cloud.member.vo.MemberDetails;
...
public class UmsMemberServiceImpl extends ServiceImpl<UmsMemberMapper, UmsMember> implements IUmsMemberService {
    ...
    public Object loginByWeixin(HttpServletRequest req) {
        try {
            ...
            JSONObject sessionData = com.cloud.util.CommonUtil.httpsRequest(requestUrl, "GET", null);

            if (null == sessionData || StringUtils.isEmpty(sessionData.getStr("openid"))) {
                throw new BusinessException("登录失败");
            }
            //验证用户信息完整性
            String sha1 = com.cloud.util.CommonUtil.getSha1(userInfos + sessionData.getStr("session_key"));
